    ...
    def log_loss(self, y_true, y_pred):
        ...
        def compute_loss(self, y_true, y_pred):
            ...
            Arguments:
                ...
                y_pred (tensor): The model prediction. The shape is identical
            ...
            # 2: Compute the classification losses for the positive and negatives targets

            negatives = y_true[:,:,0] # (batch_size,n_boxes)
            positives = tf.to_float(tf.reduce_max(y_true[:,:,1:-12],axis=-1)) #(batch_size,n_boxes)
            ...
            # (loss functions must output one scalar loss value PER batch item, rather than just
